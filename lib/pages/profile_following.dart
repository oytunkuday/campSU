...
class FollowingProfilePage extends StatefulWidget {
  const FollowingProfilePage({Key? key}) : super(key: key);

  @override
  _FollowingProfilePageState createState() => _FollowingProfilePageState();
}

class _FollowingProfilePageState extends State<FollowingProfilePage> {
  bool isPhoto = true;
